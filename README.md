...
이 저장소는 **김다정** 저자의 책 **React.js, Spring Boot, AWS로 배우는 웹 개발 101**을 따라하며 개발한 코드를 기반으로 
약간의 기능을 추가하여 Naver Cloud 서버에 배포, 운영까지 해본 프로젝트 입니다. 

## 프로젝트 개요

이 프로젝트는 **React.js**를 이용한 프론트엔드와 **Spring Boot**를 이용한 백엔드로 구성된 간단한 **Todo 애플리케이션**입니다.  
또한, **JWT**(JSON Web Token)를 활용한 인증 기능이 포함되어 있으며, **Naver cloud**를 통해 배포되었습니다.
...
- **Naver cloud**: 애플리케이션의 클라우드 배포 및 호스팅.
